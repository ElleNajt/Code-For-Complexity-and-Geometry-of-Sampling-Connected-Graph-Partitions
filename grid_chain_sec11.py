...
for pop1 in pops:
    for base in bases:
        for alignment in [2,1,0]:
            ...
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"start.png")
            plt.close()
            ...
            with open("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"wait.txt",'w') as wfile:
            ...
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"edges.png")
            plt.close()
            ...
            plt.figure()
            nx.draw(graph, pos = {x:x for x in graph.nodes()}, node_color = [dict(part.assignment)[x] for x in graph.nodes()] ,node_size = ns, node_shape ='s',cmap = 'tab20')
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"end.png")
            plt.close()
            ...
            plt.colorbar()
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"end2.png")
            plt.close()
            ...
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"wca.png")
            plt.close()
            ...
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"wca2.png")
            plt.close()
            ...
            plt.title("Slopes")
            plt.plot(slopes)
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"slope.png")
            plt.close()
            ...
            plt.plot(angles)
            plt.ylim([0,6.3])
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"angle.png")
            plt.close()
            ...
            plt.title("Flips")
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"flip.png")
            plt.close()
            ...
            plt.imshow(A2,cmap='jet')
            plt.colorbar()
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"flip2.png")
            plt.close()
            ...
            plt.title("Flips")
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"logflip.png")
            plt.close()
            ...
            plt.imshow(A2,cmap='jet')
            plt.colorbar()
            plt.savefig("./plots/sec11/"+str(alignment)+"B"+str(int(100*base))+"P"+str(int(100*pop1))+"logflip2.png")
            plt.close()
